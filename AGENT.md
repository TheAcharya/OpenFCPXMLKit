...
**Hard constraints:** [GUARDRAILS.md](GUARDRAILS.md) — must / must-not for layers, naming, FCPXML compatibility, reporting honesty, and fixtures. Prefer GUARDRAILS for “what not to do”; [ARCHITECTURE.md](ARCHITECTURE.md) for structure and diagrams.
...
- Tests/OpenFCPXMLKitTests/: Test code.
  ...
  - FCPXMLSubmittedFCPXMLSmokeTests: Optional parse smoke for private files in `Tests/Submitted FCPXML/Inbox/` (XCTSkip when empty; CI-safe).
