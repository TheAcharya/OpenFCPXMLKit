...
- The suite uses **Swift Testing** exclusively (`@Suite` / `@Test` / `#expect` / `#require`). **1166** tests are listed in `swift test list` (**1159** in `OpenFCPXMLKitTests` + **7** optional `ExcelReportTest`). See [Tests/README.md](../../Tests/README.md).
