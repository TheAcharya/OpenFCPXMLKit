...
- The suite uses **Swift Testing** exclusively (`@Suite` / `@Test` / `#expect` / `#require`). **1151** tests are listed in `swift test list` (**1144** in `OpenFCPXMLKitTests` + **7** optional `ExcelReportTest`). See [Tests/README.md](../../Tests/README.md).
