...
- The suite uses **Swift Testing** exclusively (`@Suite` / `@Test` / `#expect` / `#require`). **1228** tests are listed in `swift test list` (**1214** in `OpenFCPXMLKitTests` + **10** optional `ExcelReportTest` + **4** optional `ShotExtractionTest`). See [Tests/README.md](../../Tests/README.md).
