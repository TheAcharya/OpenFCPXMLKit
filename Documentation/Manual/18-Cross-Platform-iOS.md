...
- The `OpenFCPXMLKitTests` suite (**891 tests**) runs on **macOS** and uses the Foundation backend. `swift test` also lists 1 optional `ExcelReportTest` integration test (892 total).
