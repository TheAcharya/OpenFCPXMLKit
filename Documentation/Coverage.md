...
**Keep in sync** when adding Model types, Authoring encode/decode, Extraction presets, Projection walks, Reporting sheets, or Shot Extraction behaviour. Suite context: **1188** tests listed (`swift test list` — **1175** + **9** ExcelReportTest + **4** ShotExtractionTest); FCPXML **1.5–1.14**.
