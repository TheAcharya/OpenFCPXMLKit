...
**Public suite counts (keep in sync):** **1166** tests listed (`1159` OpenFCPXMLKitTests + `7` ExcelReportTest; **all Swift Testing**); **60** public samples under `Tests/FCPXML Samples/FCPXML/` (e.g. `HiddenMarkers.fcpxml` was promoted from this workflow).
