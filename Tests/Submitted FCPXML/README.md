...
**Public suite counts (keep in sync):** **1192** tests listed (1178 OpenFCPXMLKitTests + `10` ExcelReportTest + `4` ShotExtractionTest; **all Swift Testing**); **60** public samples under `Tests/FCPXML Samples/FCPXML/` (e.g. `HiddenMarkers.fcpxml` was promoted from this workflow).
...
| `Tests/ExcelReportTest/` | Fixture no / README yes | Local full workbook/PDF visual check (**9** optional Swift Testing tests; cancel without fixture) |
