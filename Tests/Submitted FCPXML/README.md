...
**Public suite counts (keep in sync):** **1203** tests listed (1189 OpenFCPXMLKitTests + `10` ExcelReportTest + `4` ShotExtractionTest; **all Swift Testing**); **60** public samples under `Tests/FCPXML Samples/FCPXML/` (e.g. `HiddenMarkers.fcpxml` was promoted from this workflow).
