...
**Public suite counts (keep in sync):** **1169** tests listed (`1161` OpenFCPXMLKitTests + `8` ExcelReportTest; **all Swift Testing**); **60** public samples under `Tests/FCPXML Samples/FCPXML/` (e.g. `HiddenMarkers.fcpxml` was promoted from this workflow).
