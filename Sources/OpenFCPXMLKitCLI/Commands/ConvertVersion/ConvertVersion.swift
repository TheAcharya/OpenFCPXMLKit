...
enum ConvertVersion {
    ...
    static func run(fcpxmlPath: URL, targetVersionString: String, outputDir: URL, extensionType: OutputExtensionType = .fcpxmld, logger: ServiceLogger = NoOpServiceLogger()) throws {
        ...
        if let root = converted.rootElement() {
            func findProjects(in element: any OFKXMLElement) -> [any OFKXMLElement] {
