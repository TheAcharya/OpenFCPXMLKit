...
//  OpenFCPXMLKit
//
//  Foundation backend adapter for OFKXMLElement.
...
/// A Foundation-backed XML element that conforms to `OFKXMLElement`.
///
...
public final class FoundationXMLElement: OFKXMLElement {
    ...
    // MARK: - OFKXMLElement: Attribute Access
    ...
    // MARK: - OFKXMLElement: Serialization
...
/// A Foundation-backed XML node that conforms to `OFKXMLNode`.
///
...
/// during incremental migration.
public final class FoundationXMLNode: OFKXMLNode {
