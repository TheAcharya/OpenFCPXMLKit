...
//  OpenFCPXMLKit
//
//  Foundation backend adapter for OFKXMLDTDProtocol.
...
/// A Foundation-backed XML DTD that conforms to `OFKXMLDTDProtocol`.
///
...
public final class FoundationXMLDTD: OFKXMLDTDProtocol {
    ...
    // MARK: - OFKXMLDTDProtocol Conformance
