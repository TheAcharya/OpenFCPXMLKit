...
//  Wraps `AEXMLElement` and conforms to `OFKXMLElement`.
//
...
public final class AEXMLBackendElement: OFKXMLElement {
    ...
    // MARK: - OFKXMLNode: Core Properties
    ...
    // MARK: - OFKXMLNode: Tree Traversal
