...
/// Errors that can occur during XML operations in the OpenFCPXMLKit XML abstraction layer.
///
/// This enum is `Sendable` and `Equatable` so it can be safely shared across
/// concurrency domains and used in test assertions.
public enum OFKXMLError: Error, Sendable, Equatable {
...
extension OFKXMLError: LocalizedError {
