...
extension FinalCutPro.FCPXML {
    ...
    /// > because it wraps `OFKXMLElement` which is not `Sendable`. Use with caution in concurrent contexts.
    public struct Root: FCPXMLElement, Equatable, Hashable, Codable {
        ...
        public func encode(to encoder: Encoder) throws {
            ...
            // Convert OFKXMLElement to XML string
        ...
        public init(from decoder: Decoder) throws {
            ...
            // Convert XML string to OFKXMLElement
            guard let xmlData = xmlString.data(using: .utf8) else {
                throw FCPXMLCodableError.xmlStringConversionFailed
            }

            do {
                let document = try OFKXMLDefaultFactory().makeDocument(data: xmlData, options: [])
...
extension FinalCutPro.FCPXML.Root {
    ...
    public var resources: any OFKXMLElement {
        get {
            element.firstDefaultedChildElement(whereFCPElementType: .resources, using: OFKXMLDefaultFactory())
        }
        nonmutating set {
    ...
    public var resourcesDict: [String: any OFKXMLElement] {
        get {
            resources
                .childElements
                .mapDictionary {
        ...
        nonmutating set {
            ...
            let resourcesContainer = OFKXMLDefaultFactory().makeElement(name: FinalCutPro.FCPXML.ElementType.resources.rawValue)
