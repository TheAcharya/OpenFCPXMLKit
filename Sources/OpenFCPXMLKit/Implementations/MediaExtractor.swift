...
public final class MediaExtractor: MediaExtraction, Sendable {
    ...
    public func extractMediaReferences(from document: any OFKXMLDocument, baseURL: URL?) -> MediaExtractionResult {
    ...
    public func extractMediaReferences(from document: any OFKXMLDocument, baseURL: URL?) async -> MediaExtractionResult {
        _extract(from: document, baseURL: baseURL)
    }
    ...
    private func _extract(from document: any OFKXMLDocument, baseURL: URL?) -> MediaExtractionResult {
    ...
    private func _assetMediaReference(_ assetElement: any OFKXMLElement, baseURL: URL?) -> MediaReference? {
    ...
    private func _locatorMediaReference(_ locatorElement: any OFKXMLElement, baseURL: URL?) -> MediaReference? {
