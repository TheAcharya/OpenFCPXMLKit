...
/// Helper for creating XML attributes safely via OFKXMLElement protocol.
...
public struct FCPXMLExporter: Sendable {
    ...
    ///   - factory: XML factory for creating documents and elements (default: `OFKXMLDefaultFactory()`).
    public init(version: FCPXMLVersion = .default, factory: any OFKXMLFactory = OFKXMLDefaultFactory()) {
    ...
    public func export(
        ...
        var resourceElements: [any OFKXMLElement] = []
    ...
    private func _defaultSmartCollectionElements() -> [any OFKXMLElement] {
    ...
    private func _markerElement(_ marker: Marker, utility: FCPXMLUtility) -> any OFKXMLElement {
    ...
    private func _chapterMarkerElement(_ chapterMarker: ChapterMarker, utility: FCPXMLUtility) -> any OFKXMLElement {
    ...
    private func _keywordElement(_ keyword: Keyword, utility: FCPXMLUtility) -> any OFKXMLElement {
    ...
    private func _ratingElement(_ rating: Rating, utility: FCPXMLUtility) -> any OFKXMLElement {
    ...
    private func _metadataElement(_ metadata: Metadata) -> any OFKXMLElement {
