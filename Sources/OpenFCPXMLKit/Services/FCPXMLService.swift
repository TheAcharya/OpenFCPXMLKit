...
public final class FCPXMLService: Sendable {
    ...
    ///   - logger: Logger for service operations (default: `NoOpServiceLogger()`).
    public init(
    ...
    /// - Throws: FCPXMLError
    public func parseFCPXML(from data: Data) throws -> any OFKXMLDocument {
    ...
    /// - Returns: Parsed document
    /// - Throws: FCPXMLError
    public func parseFCPXML(from url: URL) throws -> any OFKXMLDocument {
    ...
    public func createFCPXMLDocument(version: String = "1.10") -> any OFKXMLDocument {
    ...
    /// - Returns: Parsed document
    /// - Throws: FCPXMLError
    public func parseFCPXML(from data: Data) async throws -> any OFKXMLDocument {
    ...
    /// - Returns: Parsed document
    /// - Throws: FCPXMLError
    public func parseFCPXML(from url: URL) async throws -> any OFKXMLDocument {
    ...
    /// - Parameter version: FCPXML version
    /// - Returns: New document
    public func createFCPXMLDocument(version: String = "1.10") async -> any OFKXMLDocument {
    ...
    ///   - types: Types to match
    /// - Returns: Filtered elements
    public func filterElements(_ elements: [any OFKXMLElement], ofTypes types: [FCPXMLElementType]) async -> [any OFKXMLElement] {
