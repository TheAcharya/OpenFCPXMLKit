//
//  FCPXMLAnyTimeline.swift
//  OpenFCPXMLKit • https://github.com/TheAcharya/OpenFCPXMLKit
//  © 2026 • Licensed under MIT License
//

//
//	Type-erased enum containing timeline element types.
//
...
extension FinalCutPro.FCPXML {
    ...
    public enum AnyTimeline: FCPXMLElement {
        ...
        public var element: any OFKXMLElement {
            switch self {
        ...
        public init() {
            // Default to an empty gap element as a safe sentinel value.
            // AnyTimeline cannot be meaningfully constructed without a concrete element type.
            self = .gap(Gap())
        }
