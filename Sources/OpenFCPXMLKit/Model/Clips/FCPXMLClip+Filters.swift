    ...
    public var videoFilters: [FinalCutPro.FCPXML.VideoFilter] {
        ...
        nonmutating set {
            ...
            for filter in newValue {
                let filterElement = OFKXMLDefaultFactory().makeElement(name: "filter-video")
    ...
    public var videoFilterMasks: [FinalCutPro.FCPXML.VideoFilterMask] {
        ...
        nonmutating set {
            ...
            for mask in newValue {
                let maskElement = OFKXMLDefaultFactory().makeElement(name: "filter-video-mask")
                if !mask.isEnabled {
                ...
                for shape in mask.maskShapes {
                    let shapeElement = OFKXMLDefaultFactory().makeElement(name: "mask-shape")
                ...
                for isolation in mask.maskIsolations {
                    let isolationElement = OFKXMLDefaultFactory().makeElement(name: "mask-isolation")
