...
extension FCPXMLElement /* : Equatable */ {
    ...
    public static func == (lhs: any OFKXMLElement, rhs: Self) -> Bool {
        lhs === rhs.element
    }

    public static func == (lhs: Self, rhs: any OFKXMLElement) -> Bool {
        lhs.element === rhs
    }
}
...
extension FCPXMLElement {
    func _isElementTypeSupported(element: (any OFKXMLElement)? = nil) -> Bool {
