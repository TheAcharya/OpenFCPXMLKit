//
//  FCPXMLMetadata.swift
//  OpenFCPXMLKit • https://github.com/TheAcharya/OpenFCPXMLKit
//  © 2026 • Licensed under MIT License
//

//
//	Metadata container element model.
//
...
extension FinalCutPro.FCPXML.Metadata {
    // Note: init will be added when properties are implemented.
    
    // Note: not all keys use a string value; some use a string array.
...
extension FinalCutPro.FCPXML.Metadata {
    ...
    public init(from children: [any OFKXMLElement]) {
        let container = OFKXMLDefaultFactory().makeElement(name: elementType.rawValue)
...
extension FinalCutPro.FCPXML.Metadata {
    // Note: this is not an exhaustive list of metadata keys.
    ...
    public enum Key: String, Equatable, Hashable, CaseIterable {
        ...
        // Note: keys possible for exif, image, IPTC, share, and custom prefixes.
