//
//  FCPXMLRolesParsing.swift
//  OpenFCPXMLKit • https://github.com/TheAcharya/OpenFCPXMLKit
//  © 2026 • Licensed under MIT License
//

//
//	Role parsing utilities (local roles, interpolated roles).
//
...
extension OFKXMLElement {
    ...
    func _fcpLocalRoles(
        ...
        case .assetClip:
            ...
            if audioChannelSources.isEmpty {
                ...
                // Note: unclear if FCP falls back to asset clip audio role when audio channel source starts after clip start.
                // Note: behaviour with overlapping audio channel sources or missing time ranges is not fully documented.
        ...
        case .liveDrawing:
            // Note: role assignment not yet confirmed.
            break
    ...
    func _fcpRolesForNearestDescendant<I: Sequence<FinalCutPro.FCPXML.AnyRole>>(
        ...
        func elements(for element: any OFKXMLElement) -> some Sequence<any OFKXMLElement> {
        ...
        func localRoles(for element: any OFKXMLElement) -> some Sequence<FinalCutPro.FCPXML.AnyRole> {
...
// certain defaults.
// Note: these are English-only defaults; localization not yet implemented.
