...
public struct FCPXMLValidator: Sendable {
    ...
    public func validate(_ document: any OFKXMLDocument) -> ValidationResult {
        ...
        let root: (any OFKXMLElement)? = {
            ...
            for child in children {
                if child.name == "fcpxml", let el = child as? (any OFKXMLElement) {
                    return el
                }
            }
            return nil
    ...
    private func collectRefs(from element: any OFKXMLElement, into refs: inout [String]) {
    ...
    private func collectIDs(from element: any OFKXMLElement, into ids: inout Set<String>) {
    ...
    private func collectNegativeTimeWarnings(from element: any OFKXMLElement, into warnings: inout [ValidationWarning]) {
