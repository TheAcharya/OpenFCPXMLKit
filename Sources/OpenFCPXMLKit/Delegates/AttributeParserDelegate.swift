...
/// An XMLParser delegate for parsing attributes in OFKXMLElement objects.
...
final class AttributeParserDelegate: NSObject, XMLParserDelegate {
    ...
    init(element: any OFKXMLElement, attribute: String, inElementsWithName elementName: String?) {
        self.attribute = attribute
        self.elementName = elementName
        super.init()
