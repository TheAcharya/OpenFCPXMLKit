...
public protocol MediaExtraction: Sendable {
    ...
    func extractMediaReferences(from document: any OFKXMLDocument, baseURL: URL?) -> MediaExtractionResult

    /// Extracts media references (async).
    func extractMediaReferences(from document: any OFKXMLDocument, baseURL: URL?) async -> MediaExtractionResult
