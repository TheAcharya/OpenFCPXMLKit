...
//
//	OFKXMLElement extensions for FCPXML element parsing and manipulation.
//
...
extension OFKXMLElement {
	...
	public func fcpxEvent(name: String) -> any OFKXMLElement {
		let element = OFKXMLDefaultFactory().makeElement(name: "event")
	...
	/// - Returns: An element of the event.
	public func fcpxEvent(name: String, items: [any OFKXMLElement]) -> any OFKXMLElement {
	...
	public func fcpxProject(name: String, formatRef: String, duration: CMTime, tcStart: CMTime, tcFormat: TimecodeFormat, audioLayout: AudioLayout, audioRate: AudioRate, renderColorSpace: RenderColorSpace, clips: [any OFKXMLElement]) -> any OFKXMLElement {

		let element = OFKXMLDefaultFactory().makeElement(name: "project")
		element.fcpxName = name

		let sequence = OFKXMLDefaultFactory().makeElement(name: "sequence")
		...
		let spine = OFKXMLDefaultFactory().makeElement(name: "spine")
		for clip in clips {
			spine.addChild(clip)
		}
	...
	public func fcpxCompoundClip(name: String, ref: String, offset: CMTime?, duration: CMTime, start: CMTime?, useAudioSubroles: Bool) -> any OFKXMLElement {
		
		let element = OFKXMLDefaultFactory().makeElement(name: "ref-clip")
	...
	public func fcpxMulticamResource(name: String, id: String, formatRef: String, tcStart: CMTime?, tcFormat: TimecodeFormat, renderColorSpace: RenderColorSpace, angles: [any OFKXMLElement]) -> any OFKXMLElement {
		
		let element = OFKXMLDefaultFactory().makeElement(name: "media")
		
		element.fcpxName = name
		element.fcpxID = id
		
		let multicamElement = OFKXMLDefaultFactory().makeElement(name: "multicam")
	...
	public func fcpxMulticamClip(name: String, refID: String, offset: CMTime?, start: CMTime?, duration: CMTime, mcSources: [any OFKXMLElement]) -> any OFKXMLElement {
		
		let element = OFKXMLDefaultFactory().makeElement(name: "mc-clip")
	...
	public func fcpxSecondaryStoryline(lane: Int, offset: CMTime, formatRef: String?, clips: [any OFKXMLElement]) -> any OFKXMLElement {
		
		let element = OFKXMLDefaultFactory().makeElement(name: "spine")
	...
	public func fcpxGap(offset: CMTime?, duration: CMTime, start: CMTime?) -> any OFKXMLElement {
		
		let element = OFKXMLDefaultFactory().makeElement(name: "gap")
	...
	public func fcpxTitle(titleName: String, lane: Int?, offset: CMTime, ref: String, duration: CMTime, start: CMTime, role: String?, titleText: String, textStyleID: Int, newTextStyle: Bool, font: String = "Helvetica", fontSize: CGFloat = 62, fontFace: String = "Regular", fontColor: NSColor = NSColor(calibratedRed: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), strokeColor: NSColor? = nil, strokeWidth: Float = 2.0, shadowColor: NSColor? = nil, shadowDistance: Float = 5.0, shadowAngle: Float = 315.0, shadowBlurRadius: Float = 1.0, alignment: TextAlignment = TextAlignment.center, xPosition: Float = 0, yPosition: Float = 0) -> any OFKXMLElement {
		
		let element = OFKXMLDefaultFactory().makeElement(name: "title")
		...
		let text = OFKXMLDefaultFactory().makeElement(name: "text")
		let textTextStyle = OFKXMLDefaultFactory().makeElement(name: "text-style", stringValue: titleText)
		...
		if newTextStyle == true {  // If a new text style definition hasn't been created yet
			...
			let textStyleDef = OFKXMLDefaultFactory().makeElement(name: "text-style-def")
			
			textStyleDef.fcpxID = "ts\(textStyleID)"
			
			let textStyleDefTextStyle = OFKXMLDefaultFactory().makeElement(name: "text-style")
		...
		// Add the transform
		let adjustTransform = OFKXMLDefaultFactory().makeElement(name: "adjust-transform")
	...
	public func fcpxCaption(captionName: String, lane: Int?, offset: CMTime, duration: CMTime, start: CMTime, roleName: String, captionFormat: CaptionFormat, language: CaptionLanguage, captionText: String, CEA_displayStyle: CEA608CaptionDisplayStyle?, CEA_rollUpHeight: Int?, CEA_xPosition: Int?, CEA_yPosition: Int?, CEA_alignment: CEA608CaptionAlignment?, ITT_placement: ITTCaptionPlacement?, textStyleID: Int, newTextStyle: Bool, bold: Bool, italic: Bool, underline: Bool, fontColor: NSColor = NSColor(calibratedRed: 1.0, green: 1.0, blue: 1.0, alpha: 1.0), bgColor: NSColor = NSColor(calibratedRed: 1.0, green: 1.0, blue: 1.0, alpha: 1.0)) -> any OFKXMLElement {
		...
		let textTextStyle = OFKXMLDefaultFactory().makeElement(name: "text-style", stringValue: captionText)
	...
	public var fcpxProjectSequence: (any OFKXMLElement)? {
		get {
	...
	public var fcpxProjectSpine: (any OFKXMLElement)? {
		get {
	...
	public var fcpxProjectClips: [any OFKXMLElement] {
		get {
	...
	public var fcpxCompoundResourceSequence: (any OFKXMLElement)? {
		let resource: any OFKXMLElement
	...
	public var fcpxCompoundResourceSpine: (any OFKXMLElement)? {
		let resource: any OFKXMLElement
	...
	public var fcpxSequenceClips: [any OFKXMLElement] {
		get {
	...
	public var fcpxParentEvent: (any OFKXMLElement)? {
		get {
			...
			var current: any OFKXMLElement = parentNode
	...
	public var fcpxResource: (any OFKXMLElement)? {
		get {
	...
	public var fcpxAnnotations: [any OFKXMLElement] {
		get {
				var annotationElements: [any OFKXMLElement] = []
	...
	public var fcpxMetadata: [any OFKXMLElement]? {
	...
	public var fcpxMulticamAngles: [any OFKXMLElement]? {
		get {
	...
	public func referencingClips(inEvent event: any OFKXMLElement) -> [any OFKXMLElement]? {
	...
	public var eventItems: [any OFKXMLElement]? {
		get {
	...
	public var eventProjects: [any OFKXMLElement]? {
		get {
			guard self.fcpxType == .event else {
				return nil
			}
	...
	public var eventClips: [any OFKXMLElement]? {
		get {
			guard self.fcpxType == .event else {
				return nil
			}
	...
	public func eventClips(forResourceID resourceID: String) throws -> [any OFKXMLElement] {

		guard self.fcpxType == .event else {
			throw FCPXMLElementError.notAnEvent(elementName: self.name ?? "unnamed")
		}

		var matchingClips: [any OFKXMLElement] = []
	...
	public func eventClips(containingResource resource: any OFKXMLElement) throws -> [any OFKXMLElement] {

		guard self.fcpxType == .event else {
			throw FCPXMLElementError.notAnEvent(elementName: self.name ?? "unnamed")
		}

		var matchingItems: [any OFKXMLElement] = []
	...
	public func addToEvent(item: any OFKXMLElement) throws {
	...
	/// - Throws: FCPXMLElementError.notAnEvent if the element is not an event.
	public func addToEvent(items: [any OFKXMLElement]) throws {
	...
	/// - Throws: FCPXMLElementError.notAnEvent if the element is not an event.
	public func removeFromEvent(items: [any OFKXMLElement]) throws {
		guard self.fcpxType == .event else {
			throw FCPXMLElementError.notAnEvent(elementName: self.name ?? "unnamed")
		}
	...
	public func addToClip(annotationElements elements: [any OFKXMLElement]) throws {
	...
	private func formatID(forElement element: any OFKXMLElement) -> String? {
	...
	private func formatValues(fromElement element: any OFKXMLElement) -> (formatID: String, formatName: String, frameDuration: CMTime?, frameSize: CGSize?)? {
	...
	public func childElementsWithinRangeOf(_ inPoint: CMTime, outPoint: CMTime, elementType: FCPXMLElementType?) -> [(element: any OFKXMLElement, overlapsInPoint: Bool, overlapsOutPoint: Bool)] {

		var elementsInRange: [(element: any OFKXMLElement, overlapsInPoint: Bool, overlapsOutPoint: Bool)] = []

		var children: [any OFKXMLElement] = []
	...
	public func subelements(forName name: String, usingAbsoluteMatch: Bool) -> [any OFKXMLElement] {
	...
	///   - usingAbsoluteMatch: If true, names must match exactly; otherwise, partial matches are returned.
	/// - Returns: An array of matching elements.
	private func subelements(forName name: String, inElement element: any OFKXMLElement, usingAbsoluteMatch: Bool) -> [any OFKXMLElement] {

		var matchingElements: [any OFKXMLElement] = []
	...
	public func clips() -> [any OFKXMLElement] {
	...
	public func clips(forFCPXName fcpxName: String, usingAbsoluteMatch: Bool) -> [any OFKXMLElement] {
	...
	public func clips(forElementType elementType: FCPXMLElementType) -> [any OFKXMLElement] {
	...
	///   - element: The element to recursively search.
	/// - Returns: An array of matching clip elements.
	private func clips(forElementType elementType: FCPXMLElementType, inElement element: any OFKXMLElement) -> [any OFKXMLElement] {
	...
	public var nextElement: (any OFKXMLElement)? {
		get {
	...
	public func subElements() -> [any OFKXMLElement] {
		return self.childElements
	}
    ...
    public func subElement(named name: String) -> (any OFKXMLElement)? {
        firstChildElement(named: name)
    }
	
	// parentElement: provided by OFKXMLNode protocol default implementation
	...
	func parseRoles(fromElement element: any OFKXMLElement) -> [String]{
	...
	// Typealiases back into OFKXMLElement are declared there.
...
#if canImport(Logging)
private let _pnxmlElementLogger = Logger(label: "OpenFCPXMLKit.OFKXMLElement")
#endif
