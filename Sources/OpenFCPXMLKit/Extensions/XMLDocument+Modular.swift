//
//  OFKXMLDocument+Modular.swift
//  OpenFCPXMLKit • https://github.com/TheAcharya/OpenFCPXMLKit
//  © 2026 • Licensed under MIT License
//

//
//	Modular OFKXMLDocument extensions with dependency-injected operations.
//

import Foundation

/// Modular OFKXMLDocument extensions using dependency injection
@available(macOS 26.0, *)
public extension OFKXMLDocument {
    ...
    func addResource(_ resource: any OFKXMLElement, using operations: XMLDocumentOperations) {
    ...
    ///   - operations: Document operations service
    func addSequence(_ sequence: any OFKXMLElement, using operations: XMLDocumentOperations) {
