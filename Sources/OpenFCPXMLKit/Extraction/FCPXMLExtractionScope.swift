//
//  FCPXMLExtractionScope.swift
//  OpenFCPXMLKit • https://github.com/TheAcharya/OpenFCPXMLKit
//  © 2026 • Licensed under MIT License
//

//
//	Scope configuration for element extraction.
//
...
extension FinalCutPro.FCPXML.ExtractionScope {
    ...
    public static func reportMainTimelineVisible(
        ...
        let previousPredicate = scope.extractionPredicate
        scope.extractionPredicate = { extracted in
            guard extracted.value(forContext: .effectiveOcclusion) != .fullyOccluded else {
                return false
            }
            return previousPredicate?(extracted) ?? true
        }
