//
//  FCPXMLElementContextTools.swift
//  OpenFCPXMLKit • https://github.com/TheAcharya/OpenFCPXMLKit
//  © 2026 • Licensed under MIT License
//

//
//	Tools providing context for FCPXML elements during extraction.
//
...
extension FinalCutPro.FCPXML.ElementContext {
    ...
    public struct Tools {
        ...
        public func attributeValue(key: String, of element: any OFKXMLElement) -> String? {
            element.stringValue(forAttributeNamed: key)
        }
        
        /// The absolute start timecode of the element in seconds.
        /// This is calculated based on ancestor elements.
        public func absoluteStart(of element: any OFKXMLElement) -> TimeInterval? {
            element._fcpCalculateAbsoluteStart(
                ancestors: breadcrumbs
            )
        }
        ...
        public func format(for resource: any OFKXMLElement) -> FinalCutPro.FCPXML.Format? {
            resource._fcpFormatResource(in: resources)
        }
        
        /// Returns the resource element for the element.
        public var resource: (any OFKXMLElement)? {
        ...
        public func firstAncestor(named name: String, includingSelf: Bool) -> (any OFKXMLElement)? {
            ((includingSelf ? [element] : []) + breadcrumbs)
                .first(whereElementNamed: name)
        }
        
        /// Returns the first ancestor element with the given name.
        public func firstAncestor(named names: [String], includingSelf: Bool) -> (any OFKXMLElement)? {
            ((includingSelf ? [element] : []) + breadcrumbs)
                .first {
        ...
        public func firstAncestor(withAttribute attrName: String, includingSelf: Bool) -> (any OFKXMLElement)? {
            ((includingSelf ? [element] : []) + breadcrumbs)
        ...
        public func ancestorClip(includingSelf: Bool) -> (any OFKXMLElement)? {
