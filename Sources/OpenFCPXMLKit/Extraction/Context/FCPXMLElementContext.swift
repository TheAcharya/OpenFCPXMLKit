    ...
    public struct ElementContext<Value> {
        ...
        public func value(
            ...
            let resources = resources
                ...
                ?? OFKXMLDefaultFactory().makeElement(name: ElementType.resources.rawValue)
...
extension FinalCutPro.FCPXML.ElementContext {
    ...
    public typealias ValueBuilder = (
        ...
        _ breadcrumbs: [any OFKXMLElement],
        _ resources: any OFKXMLElement, // `resources` container element
        _ tools: Tools
    ) -> Value
}
